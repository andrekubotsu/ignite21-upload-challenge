...
export function FormAddImage({ closeModal }: FormAddImageProps): JSX.Element {
  ...
  const inputError = getFieldState('InputImage', formState);
  const titleError = getFieldState('TextTitle', formState);
  const descriptionError = getFieldState('TextDescription', formState);
